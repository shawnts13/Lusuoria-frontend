  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'AnnualReport',
        component: () => import('./pages/dashboard/AnnualReportPage.vue'),
        meta: { financialOnly: true }
      },
      {
        path: 'dashboard/comparison',
        name: 'TwoMonthComparison',
        component: () => import('./pages/dashboard/TwoMonthComparisonPage.vue'),
        meta: { financialOnly: true }
      },
